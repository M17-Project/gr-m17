...
void bind_m17_decoder(py::module& m)
{
    ...
    py::class_<m17_decoder, gr::block, gr::basic_block,
        ...
        .def("set_debug_data",&m17_decoder::set_debug_data,       
            py::arg("debug"),
        ...
        .def("set_debug_ctrl",&m17_decoder::set_debug_ctrl,       
            py::arg("debug"),
        ...
        .def("set_callsign",&m17_decoder::set_callsign,       
            py::arg("callsign"),
        ...
        .def("set_threshold",&m17_decoder::set_threshold,       
            py::arg("threshold"),
        ...
        .def("set_signed",&m17_decoder::set_signed,       
            py::arg("signed_str"),
        ...
        .def("set_key",&m17_decoder::set_key,       
            py::arg("key"),
        ...
        .def("set_seed",&m17_decoder::set_seed,       
            py::arg("seed"),
        ...
        .def("scrambler_sequence_generator",&m17_decoder::scrambler_sequence_generator,       
            D(m17_decoder,scrambler_sequence_generator)
        )


        
        .def("scrambler_seed_calculation",&m17_decoder::scrambler_seed_calculation,       
            py::arg("subtype"),
            py::arg("key"),
            py::arg("fn"),
