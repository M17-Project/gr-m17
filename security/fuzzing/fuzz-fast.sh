#!/bin/bash
# Fast AFL++ fuzzing with optimized settings

set -e

echo "FAST AFL++ FUZZING"
echo "=================="
...
# Create simple fast fuzz target
...
echo "Compiling fast fuzz target..."
...
echo "Starting fast fuzzing with optimized settings..."
...
echo "Fast fuzzing started with PID: $!"
