#!/bin/bash
# Final optimized AFL++ fuzzing with proper timeout

set -e

echo "FINAL OPTIMIZED AFL++ FUZZING"
echo "============================="
...
echo "Compiling optimized fuzz target..."
...
echo "Starting optimized fuzzing with proper timeout..."

# OPTIMIZED AFL++ SETTINGS with proper timeout (5ms instead of 1ms)
AFL_SKIP_CPUFREQ=1 \
AFL_FAST_CAL=1 \
AFL_NO_AFFINITY=1 \
